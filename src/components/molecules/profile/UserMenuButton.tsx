...
const UserMenuButton = () => {
  ...
  const handleMyInfo = () => {
    showDialog({
      ...
      message: <MenuButton onClick={closeDialog}>스크랩</MenuButton>,
    });
  };
  ...
  return (
    <Flex flexDirection="column">
      <MenuButton onClick={() => navigate('/bookmark')}>책갈피</MenuButton>
      <MenuButton onClick={() => navigate('/library')}>내서재</MenuButton>
      <MenuButton onClick={() => navigate('/storage')}>내 서랍</MenuButton>
